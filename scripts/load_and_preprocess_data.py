...
def calculate_morgan_fingerprints(mol_list, radius=7, n_bits=2048):
    ...
    Args:
        ...
        radius (int): Radius for Morgan Fingerprints (default: 7).
        n_bits (int): Number of bits for Morgan Fingerprints (default: 2048).
    
    Returns:
        list: List of numpy arrays representing the fingerprints.
    """
    fingerprints = []
    for mol in mol_list:
        if mol:
